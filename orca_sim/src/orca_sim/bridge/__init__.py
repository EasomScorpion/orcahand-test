...
对外接口：
    ...
    - :func:`build_local_deployer` - 只用于本地 rad→raw + 碰撞检查（不开串口，``live_control.py`` 用）。
...
from orca_sim.bridge.deploy import (  # noqa: E402
    SimToRealDeployer,
    build_deployer,
    build_local_deployer,
)
from orca_sim.bridge.limits import (  # noqa: E402
    check_alignment,
    detailed_alignment,
    format_detailed_alignment,
)
